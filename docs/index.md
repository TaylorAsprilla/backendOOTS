...
- **Características**: JWT, bcrypt, validaciones, integración con sistema de correo
...
- **Descripción**: Gestión de casos médicos asociados a participantes
- **Endpoints**: `/cases/*`
- **Características**: Información médica/clínica, seguimiento, estados
- **Uso**: Gestión de consultas y tratamientos
...
### 📧 [Sistema de Correo](../src/mail/README.md)

- **Descripción**: Sistema completo de envío de correos electrónicos
- **Características**: Plantillas HTML, SMTP, envío automático
- **Uso**: Comunicación con usuarios (bienvenida, recuperación)
...
- **Contenido**: Índice completo con flujos de trabajo
- **Casos de uso**: Implementación paso a paso del sistema
- **Flujos**: Desde autenticación hasta gestión completa de casos
...
- [x] **Sistema de Correo**: Envío automático con plantillas HTML
- [x] **Gestión de Casos**: CRUD con información médica
...
| **@nestjs-modules/mailer** | -       | Sistema de correo      |
...
- 🔄 Optimización del sistema de correo
